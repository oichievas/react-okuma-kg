    ...
    <Card className={title === 'Pro' ? classes.bordered : ''}>
      <div className={clsx(classes.priceHeader, title === 'Pro' ? classes.hasBg : '')}>
        <CardHeader
          ...
          className={clsx(title === 'Free' ? text.secondaryColor : text.primaryColor, classes.cardHeader)}
        />
        <div className={classes.cardPricing}>
          <h2 className={clsx(title === 'Free' ? text.textSecondary : text.textPrimary, text.title)}>
            $
            {price}
          </h2>
